...
for i in range(len(white_notes)):
    white_sounds.append(mixer.Sound(os.path.join("assets", "notes", white_notes[i] + ".wav")))

for i in range(len(black_notes)):
    black_sounds.append(mixer.Sound(os.path.join("assets", "notes", black_notes[i] + ".wav")))
